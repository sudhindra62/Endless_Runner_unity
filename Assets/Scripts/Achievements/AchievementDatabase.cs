...
using System.Collections.Generic;
    ...
    public class AchievementDatabase : ScriptableObject
    {
        ...
        /// <summary>
        /// Retrieves an achievement by its AchievementID key.
        /// </summary>
        public bool GetAchievement(AchievementID id, out Achievement achievement)
        {
            achievement = Achievements.Find(a => a.id == id.ToString());
            return achievement != null;
        }

        /// <summary>
        /// Retrieves an achievement by its string id directly.
        /// </summary>
        public bool GetAchievement(string id, out Achievement achievement)
        {
